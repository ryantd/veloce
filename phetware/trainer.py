...
callback_mapping = {
    "json": JsonLoggerCallback,
    "tbx": TBXLoggerCallback
}
...
class NeuralNetTrainer(object):
    def __init__(
        self,
        module, module_params, dataset, dataset_options,
        epochs, batch_size, loss_fn, optimizer, metric_fns,
        num_workers, use_gpu, callbacks=None
    ):
        self.model = module
